...
public final class IPv4 {
     ...
     * If the query fails, the wrapped value of the returned {@link IPv4} value is {@code null}.
    ...
    public boolean equals(Object obj) {
        ...
        if (isNull() || asIPv4.isNull()) return false;
        if (isNull() && asIPv4.isNull()) return true;
